...
function startGame() {
    for (let r= 0; r<rows; r++){
        ...
        for (let c =0; c< columns; c++){
            ...
            tile.addEventListener("dragover", dragOver); //click on candy, moving mouse to drag candy
...
function handleTouchStart(event) {
    ...
    // Save the current tile for reference
    currTile = this;
}
...
function handleTouchEnd(event) {
    event.preventDefault();
     ...
     // Check if the touch end is on a valid tile
     if (otherTile && otherTile.tagName === 'IMG') {
         // Perform the candy swap
         let currImg = currTile.src;
         let otherImg = otherTile.src;
         currTile.src = otherImg;
         otherTile.src = currImg;
...
function crushFour(){
    ...
    for (let r =0; r<rows; r++){
        for(let c= 0; c<columns-3; c++){
            ...
            if (candy1.src===candy2.src && candy2.src== candy3.src && candy2.src== candy4.src &&!candy1.src.includes("blank")){
                 candy1.src = "./images/blank.png";
                 candy2.src = "./images/blank.png";
                 candy3.src = "./images/blank.png";
